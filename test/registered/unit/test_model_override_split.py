...
reorder freely (isort did, mid-split, and flipped which module won for
InternS2Mobius; nothing changed, because there was no overlap to change). With
no overlap the list can be sorted however anyone likes.
