...
class _IsolatedRegistry(CustomTestCase):
    ...
    def setUp(self):
        super().setUp()
        # The registries live in `model_override_base`, and that is the one
        # address to isolate: the registrars write there, and
        # `collect_model_override_declarations` reads there.
        self._patches = [
